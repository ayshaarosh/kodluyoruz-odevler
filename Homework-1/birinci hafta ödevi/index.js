...
document.querySelector("#loadPost").addEventListener("click", () => {
  ...
  const renderPost = (data = []) => {
    ...
    document.getElementById("loadUsers").style.display = " ";
  ...
  //kullanıcı bilgilerinin alındığı yer
  ...
  const loadUsers = () => {
    ...
    document.getElementById("loadPost").style.display = " ";
  ...
  const renderUsers = (users = []) => {
    ...
    <th scope="col">Id</th>
      ...
      <th id="reverseName" scope="col" >Name</th>
      <th scope="col">Email</th>
      <th scope="col">Phone</th>
      <th scope="col">Website</th>
    ...
    tbody.innerHTML = users.map((user, index) => {
      return `<tr>
        ...
        <th scope="row" id="list">${index + 1}</th>
        <td>${user.name}</td>
        <td>${user.email}</td>
        <td>${user.phone}</td>
        <td>${user.website}</td>
    ...
    //name bölümünün reverse edilmesi
    document.querySelector("#reverseName").addEventListener("click", reverseName)
    ...
    //bilgilerin silinme olayının gerçekleştiği yer
    ...
    //bilgilerin update edilmesini sağlayan yer
